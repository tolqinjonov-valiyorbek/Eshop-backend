...
const createOrder = asyncHandler(async (req, res) => {
  const {shipingInfo, orderItems, totalPrice, totalAfterDiscount, paymentInfo} = req.body;
  const { _id } = req.user;
  try {
    const order = await Order.create({
      shipingInfo, orderItems, totalPrice, totalAfterDiscount,paymentInfo, user : _id
